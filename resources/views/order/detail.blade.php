    ...
    <div class="container">
        <div class="row mb-3 d-flex">
            <div class="col-md-4">
                ...
                <hr class="new1"/>
                <a href="{{ route('order.pdf', $order->id) }}">Cetak PDF</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul class="list-group list-group-display-user mb-3">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <span class="font-bold">{{ $order->getKerajinan->getUser->getPengrajin->no_rek }}</span>
                            </div>
                        </div>
                    </li>
                    @endif
                ...
                <div class="text-center mb-5">
                    ...
                    @else
                    <a href="https://wa.me/{{ $order->getKerajinan->getUser->getPengrajin->no_telp }}" class="btn btn-whatsapp"><i class="fab fa-whatsapp"></i> Hubungi Penjual</a>
            ...
            <div class="col-md-6">
                ...
                <img src="{{ asset($order->getKerajinan->gambar) }}" alt="{{ $order->getKerajinan->nama }}" width="100%" class="mb-2">

                <div class="row">
                    <div class="col-md-12">
                        <h5>{{ $order->getKerajinan->nama }}</h5>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @else
                        <label>{{ __('Oleh ') }} <span class="font-bold">{{ $order->getKerajinan->getUser->getPengrajin->nama }}</span></label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label>{{ __('Kategori ') }} <span class="font-bold">{{ $order->getKerajinan->getUser->getKategori->nama }}</span></label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-5 font-large">
                        <span>{{ $order->jumlah_barang }} * {{ number_format($order->getKerajinan->harga) }}</span>
                    </div>
